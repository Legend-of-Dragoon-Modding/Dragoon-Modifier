...
namespace Dragoon_Modifier.DraMod.Dataset.Scripts.HellMode.Characters {
    internal class Shana : ICharacter {
            ...
            if (battleTable.ID == 2) {
                switch (dlv) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "0B 0A 20 FF FF FF FF FF");
                        break;
                    case 4:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "0B 0A 20 0C FF FF FF FF");
                        break;
                    case 5:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "0B 0A 20 0C 0D FF FF FF");
                        break;
                    case 6:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "0B 0A 20 0C 0D 21 FF FF");
                        break;
                    case 7:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "0B 0A 20 0C 0D 21 22 FF");
                        break;
                }
            } else {
                switch (dlv) {
                    case 1:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "42 FF FF FF FF FF FF FF");
                        break;
                    case 2:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "42 41 FF FF FF FF FF FF");
                        break;
                    case 3:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "42 41 20 FF FF FF FF FF");
                        break;
                    case 4:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "42 41 20 43 FF FF FF FF");
                        break;
                    case 5:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "42 41 20 43 0D FF FF FF");
                        break;
                    case 6:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "42 41 20 43 0D 21 FF FF");
                        break;
                    case 7:
                        Emulator.DirectAccess.WriteAoB(Emulator.GetAddress("DRAGOON_SPELL_SLOT") + slot * 0x9 + 1, "42 41 20 43 0D 21 22 FF");
                        break;
                }
            }
        ...
        private void WriteMP(Core.Memory.Battle.Character battleTable) {
            Core.Memory.Battle.DragoonSpell moonLight = new Core.Memory.Battle.DragoonSpell(6);
            Core.Memory.Battle.DragoonSpell gatesOfHeaven = new Core.Memory.Battle.DragoonSpell(11);
            Core.Memory.Battle.DragoonSpell moonLight2 = new Core.Memory.Battle.DragoonSpell(12);
            ...
            moonLight.MP = _moonLightMP;
            moonLight2.MP = _moonLightMP;
            ...
            if (deadPartyMembers > 0) {
                gatesOfHeaven.DamageMultiplier = (byte) (_gatesOfHeavenHealBase - (deadPartyMembers * _gatesOfHeavenHellModePenalty));
            }
