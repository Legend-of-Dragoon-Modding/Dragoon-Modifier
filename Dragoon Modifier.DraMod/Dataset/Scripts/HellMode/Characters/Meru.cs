...
namespace Dragoon_Modifier.DraMod.Dataset.Scripts.HellMode.Characters {
    internal class Meru : ICharacter {
        ...
        private const byte _rainbowBreathMP = 30;
        ...
        private void WriteMP(Core.Memory.Battle.Character battleTable) {
            ...
            Core.Memory.Battle.DragoonSpell rainbowBreath = new Core.Memory.Battle.DragoonSpell(25);
            spearFrost.MP = _spearFrostMP;
            boost.MP = _boostMP;
            waterAttack.MP = _waterAttackMP;
            rainbowBreath.MP = _rainbowBreathMP;
