...
namespace Dragoon_Modifier.MemoryController {
    public class CharacterAddress : BattleEntityAddress {
        ...
        public byte A_HIT { get { return Emulator.ReadByte(_baseAddress + 0x34); } set { Emulator.WriteByte(_baseAddress + 0x34, value); } }
        public byte M_HIT { get { return Emulator.ReadByte(_baseAddress + 0x36); } set { Emulator.WriteByte(_baseAddress + 0x36, value); } }
        ...
        public byte SP_P_Hit { get { return Emulator.ReadByte(_baseAddress + 0x122); } set { Emulator.WriteByte(_baseAddress + 0x122, value); } }
        public byte MP_P_Hit { get { return Emulator.ReadByte(_baseAddress + 0x124); } set { Emulator.WriteByte(_baseAddress + 0x124, value); } }
        public byte SP_M_Hit { get { return Emulator.ReadByte(_baseAddress + 0x126); } set { Emulator.WriteByte(_baseAddress + 0x126, value); } } 
        public byte MP_M_Hit { get { return Emulator.ReadByte(_baseAddress + 0x128); } set { Emulator.WriteByte(_baseAddress + 0x128, value); } }
