...
namespace Dragoon_Modifier.MemoryController {
    public class CharacterAddress : BattleEntityAddress {
        ...
        public byte Pandemonium { get { return (byte) (Emulator.ReadByte(_pShieldMshieldSigStone + 0x1) & 3); } set { Emulator.WriteByte(_pShieldMshieldSigStone + 0x1, (byte) (Emulator.ReadByte(_pShieldMshieldSigStone) | Math.Min(value, (byte) 3))); } }
