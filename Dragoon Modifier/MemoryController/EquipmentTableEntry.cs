...
namespace Dragoon_Modifier.MemoryController {
    public class EquipmentTableEntry {
        ...
        public byte Icon { get { return Emulator.ReadByte(_baseAddress + 0xE); } set { Emulator.WriteByte(_baseAddress + 0xE, value); } }
        ...
        public EquipmentTableEntry(int baseAddress, int namePointerAddress, int descriptionPointerAddress, int item) {
