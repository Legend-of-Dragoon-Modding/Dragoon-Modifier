...
public class BattleController {
    public static void Run(Emulator emulator) {
        ...
        if (Globals.IN_BATTLE && Globals.STATS_CHANGED && encounterValue == 41215 && Globals.PARTY_SLOT[0] == 4 && emulator.ReadByte(Constants.GetAddress("HASCHEL_FIX")) != 0x80) {
            Constants.WriteDebug("Haschel Fix");
            emulator.WriteAOB(Constants.GetAddress("HASCHEL_FIX"), ("0x80 0x80 0x80 0x00 0x90 0xA0 0x1E 0x80 0x74 0x12 0x00 0x00 0x02 0x00 0x8C 0x8C 0x4D 0x52 0x47 0x1A 0x04 0x00 0x00 0x00 0x28 0x00" +
