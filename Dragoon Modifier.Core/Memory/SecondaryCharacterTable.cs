...
namespace Dragoon_Modifier.Core.Memory {
    public class SecondaryCharacterTable {
        ...
        public ushort MaxHP { get { return Emulator.ReadUShort(_baseAddress + 0x66); } set { Emulator.WriteUShort(_baseAddress + 0x66, value); } }
        ...
        public ushort MaxMP { get { return Emulator.ReadUShort(_baseAddress + 0x6E); } set { Emulator.WriteUShort(_baseAddress + 0x6E, value); } }
        ...
        public byte SpecialEffect { get { return Emulator.ReadByte(_baseAddress + 0x76); } set { Emulator.WriteByte(_baseAddress + 0x76, value); } } // Old Death_Res
        ...
        public byte OnHitStatus { get { return Emulator.ReadByte(_baseAddress + 0x98); } set { Emulator.WriteByte(_baseAddress + 0x98, value); } }
        public byte OnHitStatusChance { get { return Emulator.ReadByte(_baseAddress + 0x9B); } set { Emulator.WriteByte(_baseAddress + 0x9B, value); } }
