...
namespace Dragoon_Modifier.Core {
    public static class Emulator {
        ...
        public static byte ReadByte(string address, int offset = 0) {
            ...
            Output.WriteError($"Incorrect addres key {address}.");
            return 0;
        }
        ...
        */
        ...
        private static bool Emulators(Process proc, string emulatorName) {
        ...
        private static bool ePSXe(Process proc) {
            EmulatorOffset = 0;
        ...
        private static Dictionary<string, int> LoadRegionalAddresses(Region region) {
