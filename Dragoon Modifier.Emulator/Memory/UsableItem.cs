...
namespace Dragoon_Modifier.Emulator.Memory {
    internal class UsableItem : Item, IUsableItem {
        ...
        public string BattleName { get { return _emulator.ReadText(BattleNamePointer); } }
        public uint BattleNamePointer { get { return _emulator.ReadUInt24(_battleNamePointerAddress); } set { _emulator.WriteUInt24(_battleNamePointerAddress, value); } }
        public string BattleDescription { get { return _emulator.ReadText(BattleDescriptionPointer); } }
        public uint BattleDescriptionPointer { get { return _emulator.ReadUInt24(_battleDescriptionPointerAddress); } set { _emulator.WriteUInt24(_battleDescriptionPointerAddress, value); } }
        

        internal UsableItem(IEmulator emulator, int baseAddress, int namePointerAddress, int descriptionPointerAddress, int battleNamePointerAddress, int battleDescriptionPointerAddress, int sellPriceAddress, int item) : base() {
            _emulator = emulator;
