...
namespace Dragoon_Modifier.Emulator {
    internal class Emulator : IEmulator {
        ...
        private static readonly Dictionary<string, int[]> _addressList = new Dictionary<string, int[]> {
            ...
            { "DISC", new int[] { 0xBC058, 0xBAD58 ,0xBC340 ,0x0 ,0x0 ,0xBC380 ,0xBC290 } },
            { "CHAPTER", new int[] { 0xBAC60, 0xB9960, 0xBAF48, 0x0, 0x0, 0xBAF88, 0xBAE98 } },
            { "MAP", new int[] { 0x52C30, 0x51930, 0x52F18, 0x0, 0x0, 0x52F5C, 0x52E6C } },
            { "DRAGOON_SPIRITS", new int[] { 0xBAD64, 0xB9A64, 0xBAF9C, 0x0, 0x0, 0xBB08C, 0xBAF9C } },
            { "HOTKEY", new int[] { 0x7A39C, 0x7909C, 0x7A684, 0x0, 0x0, 0x7A6C4, 0x7A5D4 } },
            { "BATTLE_VALUE", new int[] { 0xC6AE8, 0xC5808, 0xC6DD0, 0x0, 0x0, 0xC6E10, 0xC6D20 } },
            { "ARMOR_INVENTORY", new int[] { 0xBADB0, 0xB9AB0, 0x0, 0x0, 0x0, 0xBB0D8, 0xBAFE8 } },
            { "INVENTORY", new int[] { 0xBAEB1, 0xB9BB1, 0x0, 0x0, 0x0, 0xBB1D9, 0xBB0E9 } },
            { "MENU", new int[] { 0xBDC38, 0xBC938, 0xBDF20, 0x0, 0x0, 0x0, 0xBDE70 } },
            { "TRANSITION", new int[] { 0xCB430 ,0xCA150, 0xCB718, 0x0, 0x0, 0x0, 0xCB668 } },
            { "GOLD", new int[] { 0xBAC5C, 0xB995C, 0xBAE94, 0x0, 0x0, 0xBAF84, 0xBAE94 } },
            { "MENU_UNLOCK", new int[] { 0xFD4B8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 } },
            { "CHAR_TABLE", new int[] { 0xBAEF4, 0xB9BF4, 0x0, 0x0, 0x0, 0xBB21C, 0xBB12C } },
            { "SECONDARY_CHARACTER_TABLE", new int[] { 0xBE5F8, 0xBD2F8, 0x0, 0x0, 0x0, 0xBE920, 0xBE830} },
            { "MENU_ADDITION_TABLE_FLAT", new int[] { 0x52884, 0x51584, 0x0, 0x0, 0x0, 0x52BB0, 0x52ABC } },
            { "MENU_ADDITION_TABLE_MULTI", new int[] { 0x113BF7, 0x11238B, 0x0, 0x0, 0x0, 0x113EA3, 0x113D43 } },
            { "SHOP_LIST", new int[] { 0xF4930, 0xF3AF8, 0x0, 0x0, 0x0, 0xF51B0, 0xF4B98 } },
            ...
            { "MONSTER_REWARDS", new int[] { 0x5E52C, 0x5D22C, 0x5E764, 0x0, 0x0, 0x5E854, 0x5E764 } },
            { "BATTLE_OFFSET", new int[] { 0xBDA0C, 0x0, 0x0 ,0x0 ,0x0 ,0x1B3BB0 ,0xBDC44 } },
            { "UNIQUE_MONSTER_SIZE", new int[] { 0xC6698, 0xC53B8, 0xC6980, 0x0, 0x0, 0xC69C0, 0xC68D0 } },
            { "UNIQUE_SLOT", new int[] { 0x5E53A, 0x5D23A, 0x5E252, 0x0, 0x0, 0x5E862, 0x5E772 } },
            { "ENCOUNTER_ID", new int[] { 0xBB0F8, 0xB9DF8, 0xBB3E0, 0x0, 0x0, 0xBB420, 0xBB330 } },
            ...
            { "DRAGOON_TABLE", new int[] { 0x111B4C, 0x1102E0, 0x0, 0x0, 0x0, 0x111DF8, 0x111C98 } },
            ...
            { "MONSTERS_NAMES", new int[] { 0xC69D0, 0xC56F0, 0xC6C08, 0x0, 0x0, 0xC6CF8, 0xC6C08 } },
            { "ASPECT_RATIO", new int[] { 0xC3568, 0xC22A8, 0xC37A0, 0x0, 0x0, 0xC3890, 0xC37A0 } },
            { "ADVANCED_CAMERA", new int[] { 0xE8208, 0xE6F08, 0xE8440, 0x0, 0x0, 0xE84D4, 0xE83E4 } },
            { "ADDITION", new int[] { 0x1CF940, 0x1CE948, 0x0, 0x0, 0x0, 0x1CFCD0, 0x1CFCD0 } }
